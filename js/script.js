...
try{
    ...
    console.log(data)
        ...
        // create array with all titles
    const titlesArray = data.Search.map((data) =>{
        return data.imdbID

    })
    console.log(titlesArray)
        
    // fetch rating using movie titles

    const getMovies = await Promise.all(titlesArray.map(async function(titles){

        const searchedByTitle = await fetch(`https://www.omdbapi.com/?i=${titles}&apikey=30cf1013`);

        const movies = await searchedByTitle.json();
            ...
            <div class="grid-card">
                ...
                <div class="movie-card">
                    ...
                    <div class="movie-info">
                        ...
                        <svg class="watchlistIcon" class="watchlistIcon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
